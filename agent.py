...
# Khai báo edges:
# START → agent: bắt đầu luôn ở agent node
builder.add_edge(START, "agent")

# agent → tools hoặc END: dùng tools_condition để quyết định
# Nếu agent gọi tool → đến "tools" node
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if user_input.lower() in ("quit", "exit", "q"):
            print("\n👋 Hẹn gặp lại! Chúc bạn có chuyến đi vui vẻ!")
            break
